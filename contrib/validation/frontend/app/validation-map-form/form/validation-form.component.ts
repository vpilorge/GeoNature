...
export class ValidationFormComponent implements OnInit {
  ...
  constructor(
    ...
    private _cfs: ValidationService
  ...
  ngOnInit() {
    ...
    if (!isNaN(this.id)) {
      ...
      // load one releve
      this.validationService.getOneReleve(this.id).subscribe(data => {
        // pre fill the form
        ...
        // set the occurrence
        this.fs.indexOccurrence = data.releve.properties.t_occurrences_validation.length;
  ...
  submitData() {
    ...
    finalForm.properties.t_occurrences_validation.forEach((occ, index) => {
    ...
    this._cfs.postValidation(finalForm).subscribe(
      response => {
