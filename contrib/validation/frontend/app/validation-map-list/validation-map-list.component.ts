...
@Component({
  selector: "pnx-validation-map-list",
  templateUrl: "validation-map-list.component.html",
  styleUrls: ["./validation-map-list.component.scss"],
  providers: [MapListService]
})
export class ValidationMapListComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.displayColumns = ValidationConfig.default_maplist_columns;
